...
5. Sections fade between one another with page-like snapping; to simplify scrolling, remove the `IntersectionObserver` logic near the end of `index.html` and change `.page-stack { scroll-snap-type: none; }` in `styles.css`.
